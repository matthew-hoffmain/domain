...
and I do not condone the usage of AI in any form of academic dishonesty.
...
the concept of [[LLMs (large language models)]] was not new to me. What was surprising was that there was now a commercially
...
and text is what it produces. Thanks to the [[internet-as-a-corpus]], developers of LLMs have access to a virtually endless dataset for training text based models.
